...
import Competition from "../Assests/Illustrator/CallFor06.png";

function CallForCompetiton({ mheight, height }) {
          ...
          <div className="card-container" style={{ height: height }}>
            <div className="call-for-container">
              <div
                ...
                data-aos-delay="800"
              >
                <img src={Competition} height={300} alt="" />
              </div>
              <div className="call-for-message">
                ...
                >
                  ...
                  <span style={{ fontWeight: 500, fontSize: "1.2rem" }}>
                    The ICPR-2024 Competition Chairs will invite proposals for
                    Competition to be organized in conjunction with the main
                    conference to be held during December 01-05, 2024.
                  </span>
                </div>
              </div>
            </div>
...
export default CallForCompetiton;
